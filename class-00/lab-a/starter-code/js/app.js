...
function displayPics(){
  ...
  // The reason this code works is because rando operates inside the function displayPics and when 'var' is used it is global and when const is used it becomes unrecognized. 
  console.log(viewed);
